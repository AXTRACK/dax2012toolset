...
{
    // Based on extension by Tomas Restrepo @tomasrestrepo
    ...
    public class CurrentLineHighlight
    {
        ...
        private void LoadSettings()
        {
            ...
            EnableCL = settings.GeneralSettings.EnableCL;
        }

        public CurrentLineHighlight(IWpfTextView view, IClassificationFormatMap formatMap, IClassificationType formatType)
        {
            this.LoadSettings();
